        ...
        if (module != null && servicesAttachment != null) {
            ...
            for (String driverName : driverNames) {
                try {
                    ...
                    phaseContext.getServiceTarget().addService(ServiceName.JBOSS.append("jdbc-driver", driverName, Integer.toString(majorVersion), Integer.toString(minorVersion)), new ValueService<Driver>(new ImmediateValue<Driver>(driver)));
                } catch (Exception e) {
